...
def get_sales_data():
    ...
    by commas. The loop will repeateadly request data, until it is valid.
    """
    while True:
...
def validate_data(values):
    ...
    into int, or if there arent't exactly 6 values.
    """
    try:
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracred from the stock:
